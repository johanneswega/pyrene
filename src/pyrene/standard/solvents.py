...
solvent_dic = {
            'ACN': [1.341, 35.94, 0.6115, 0.341, 0.19],
            'VCN': [1.395, 19.71, 0.539, 0.692, np.nan],
            ...
            'DMF': [1.428, 36.71, 0.5504, 0.802, np.nan],
            ...
            'TFE': [1.2907, 26.67, 0.6373, 1.755, np.nan], # 2,2,2-trifluoroethanol
            'PFH': [1.251, 1.57, onsager(1.251, 1.57), np.nan, np.nan], # perfluorohexane
            'BBZ': [1.557, 2.65, onsager(1.557, 2.65), 1.069, np.nan], # bromo-benzene
            'BZA': [1.5384, 12.7, onsager(1.5384, 12.7), 6.54, np.nan], # benzyl alcohol
